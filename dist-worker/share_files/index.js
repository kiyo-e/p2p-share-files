...
var createRenderer = (c, Layout2, component, options) => (children, props) => {
  const docType = "<!DOCTYPE html>";
  const currentLayout = children;
...
class Room extends DurableObjectBase {
  ...
  async fetch(request) {
    ...
    if (url.pathname === "/config") {
      ...
      const creatorCid = typeof body.creatorCid === "string" ? body.creatorCid : void 0;
    ...
    server.send(JSON.stringify({ type: "role", role, cid: clientId }));
    if (role === "answerer") {
      server.send(JSON.stringify({ type: "wait" }));
    }
    this.broadcastPeers();
    this.fillSlots();
  ...
  webSocketMessage(ws, message) {
    ...
    if (msg.type === "offer" || msg.type === "answer" || msg.type === "candidate") {
      ...
      if (!target) return;
      const payload = msg.type === "offer" ? { type: "offer", from: attachment.cid, sid: msg.sid, sdp: msg.sdp } : msg.type === "answer" ? { type: "answer", from: attachment.cid, sid: msg.sid, sdp: msg.sdp } : { type: "candidate", from: attachment.cid, sid: msg.sid, candidate: msg.candidate };
  ...
  webSocketClose(ws) {
    ...
    if (attachment?.role === "answerer") {
      ...
      if (offerer && attachment.cid) {
        offerer.send(JSON.stringify({ type: "peer-left", peerId: attachment.cid }));
      }
      this.fillSlots();
    }
  ...
  async ensureConfig() {
    ...
    const stored = await this.ctx.storage.get("config");
  ...
  fillSlots() {
    ...
    const waiting = this.answererSockets().filter((socket) => {
      const attachment = socket.deserializeAttachment();
      return attachment?.state === "waiting";
    }).sort((a, b) => {
      const aJoined = a.deserializeAttachment()?.joinedAt ?? 0;
      const bJoined = b.deserializeAttachment()?.joinedAt ?? 0;
    ...
    for (const socket of toActivate) {
      ...
      offerer.send(JSON.stringify({ type: "start", peerId: attachment.cid }));
    }
  }
  closeDuplicateClient(clientId) {
    for (const socket of this.ctx.getWebSockets()) {
      const attachment = socket.deserializeAttachment();
      if (attachment?.cid === clientId) {
        log("[room] closing duplicate client, cid:", clientId, "role:", attachment.role);
        socket.close(1e3, "replaced");
      }
    }
  }
}
...
function Layout({ title: title2, scripts, children, bodyAttrs = {} }) {
  return /* @__PURE__ */ jsxDEV("html", { lang: "ja", children: [
    /* @__PURE__ */ jsxDEV("head", { children: [
      /* @__PURE__ */ jsxDEV("meta", { charset: "UTF-8" }),
      /* @__PURE__ */ jsxDEV("meta", { name: "viewport", content: "width=device-width,initial-scale=1" }),
      /* @__PURE__ */ jsxDEV("meta", { name: "theme-color", content: "#f5f5f0" }),
      /* @__PURE__ */ jsxDEV("title", { children: title2 }),
      /* @__PURE__ */ jsxDEV("link", { rel: "stylesheet", href: "/style.css" })
    ] }),
    /* @__PURE__ */ jsxDEV("body", { ...bodyAttrs, children: [
      /* @__PURE__ */ jsxDEV("header", { class: "topbar", children: [
        /* @__PURE__ */ jsxDEV("a", { href: "/", class: "brand", children: "SHARE—FILES" }),
        /* @__PURE__ */ jsxDEV("div", { class: "sub", children: "P2P / 1:1 / WEBRTC" })
      ] }),
      /* @__PURE__ */ jsxDEV("main", { class: "container", children }),
      scripts.map((src) => /* @__PURE__ */ jsxDEV("script", { type: "module", src }))
    ] })
  ] });
}
function TopPage({ scripts }) {
  return /* @__PURE__ */ jsxDEV(Layout, { title: "SHARE-FILES", scripts, children: /* @__PURE__ */ jsxDEV("section", { id: "homeView", class: "card home", children: [
    /* @__PURE__ */ jsxDEV("div", { class: "homeGrid", children: [
      /* @__PURE__ */ jsxDEV("div", { class: "homeHero", children: [
        /* @__PURE__ */ jsxDEV("div", { class: "eyebrow", children: "DIRECT—PRIVATE—INSTANT" }),
        /* @__PURE__ */ jsxDEV("h1", { children: [
          "ファイルを",
          /* @__PURE__ */ jsxDEV("br", {}),
          "直接送る"
        ] }),
        /* @__PURE__ */ jsxDEV("p", { class: "lead", children: "サーバにアップロードせず、端末間で直接転送。接続の取り次ぎだけサーバを使います。" }),
        /* @__PURE__ */ jsxDEV("div", { class: "heroChips", children: [
          /* @__PURE__ */ jsxDEV("span", { class: "chip", children: "NO SERVER STORAGE" }),
          /* @__PURE__ */ jsxDEV("span", { class: "chip", children: "1:N P2P" }),
          /* @__PURE__ */ jsxDEV("span", { class: "chip", children: "WEBRTC" })
        ] }),
        /* @__PURE__ */ jsxDEV("div", { class: "steps", children: [
          /* @__PURE__ */ jsxDEV("div", { class: "step", children: [
            /* @__PURE__ */ jsxDEV("span", { children: "1" }),
            " ルーム作成"
          ] }),
          /* @__PURE__ */ jsxDEV("div", { class: "step", children: [
            /* @__PURE__ */ jsxDEV("span", { children: "2" }),
            " リンク共有"
          ] }),
          /* @__PURE__ */ jsxDEV("div", { class: "step", children: [
            /* @__PURE__ */ jsxDEV("span", { children: "3" }),
            " 送信"
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxDEV("div", { class: "homePanel", children: [
        /* @__PURE__ */ jsxDEV("div", { class: "panelBlock", children: [
          /* @__PURE__ */ jsxDEV("div", { class: "panelTitle", children: "送信を開始" }),
          /* @__PURE__ */ jsxDEV("label", { class: "toggle", children: [
            /* @__PURE__ */ jsxDEV("input", { id: "encryptToggle", type: "checkbox", checked: true }),
            /* @__PURE__ */ jsxDEV("span", { children: "E2E暗号化ON" })
          ] }),
          /* @__PURE__ */ jsxDEV("label", { class: "row gap", children: [
            /* @__PURE__ */ jsxDEV("span", { class: "muted small", children: "同時送信上限" }),
            /* @__PURE__ */ jsxDEV("input", { id: "maxConcurrent", class: "input", type: "number", min: "1", max: "10", value: "3" })
          ] }),
          /* @__PURE__ */ jsxDEV("button", { id: "createBtn", class: "btn primary", children: "ルーム作成" })
        ] }),
        /* @__PURE__ */ jsxDEV("hr", { class: "sep" }),
        /* @__PURE__ */ jsxDEV("div", { class: "panelBlock", children: [
          /* @__PURE__ */ jsxDEV("div", { class: "panelTitle", children: "受信に参加" }),
          /* @__PURE__ */ jsxDEV("div", { class: "row gap wrap", children: [
            /* @__PURE__ */ jsxDEV("input", { id: "joinCode", class: "input", placeholder: "コード入力（例: ABCD...）" }),
            /* @__PURE__ */ jsxDEV("button", { id: "joinBtn", class: "btn", children: "参加" })
          ] }),
          /* @__PURE__ */ jsxDEV("p", { class: "muted small", children: "暗号化ONならリンクに鍵が含まれます。" })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxDEV("div", { class: "foot muted", children: "P2Pのみ。ネットワーク条件によっては接続不可（TURN無し）" })
  ] }) });
}
function RoomPage({ roomId, scripts }) {
  return /* @__PURE__ */ jsxDEV(
    Layout,
    {
      ...
      children: /* @__PURE__ */ jsxDEV("section", { id: "roomView", class: "card room", children: [
        /* @__PURE__ */ jsxDEV("div", { class: "roomHeader", children: [
          /* @__PURE__ */ jsxDEV("div", { class: "roomTitle", children: [
            /* @__PURE__ */ jsxDEV("div", { class: "eyebrow", children: "ROOM—SESSION" }),
            /* @__PURE__ */ jsxDEV("h2", { children: [
              "ROOM ",
              /* @__PURE__ */ jsxDEV("span", { id: "roomIdLabel", class: "mono", children: roomId })
            ] }),
            /* @__PURE__ */ jsxDEV("div", { id: "status", class: "status", children: "初期化中..." })
          ] }),
          /* @__PURE__ */ jsxDEV("div", { class: "right", children: [
            /* @__PURE__ */ jsxDEV("button", { id: "copyLinkBtn", class: "btn", children: "LINK" }),
            /* @__PURE__ */ jsxDEV("button", { id: "copyCodeBtn", class: "btn", children: "CODE" })
          ] })
        ] }),
        /* @__PURE__ */ jsxDEV("div", { class: "roomGrid", children: [
          /* @__PURE__ */ jsxDEV("div", { class: "roomSide", children: [
            /* @__PURE__ */ jsxDEV("div", { class: "kv", children: [
              /* @__PURE__ */ jsxDEV("div", { class: "k", children: "ROLE" }),
              /* @__PURE__ */ jsxDEV("div", { class: "v", id: "roleLabel", children: "—" }),
              /* @__PURE__ */ jsxDEV("div", { class: "k", children: "PEERS" }),
              /* @__PURE__ */ jsxDEV("div", { class: "v", id: "peersLabel", children: "0" })
            ] }),
            /* @__PURE__ */ jsxDEV("div", { class: "sideCard muted small", children: "暗号化ONの場合、リンクの「#」以降に復号鍵が含まれます（サーバには送られません）。" })
          ] }),
          /* @__PURE__ */ jsxDEV("div", { class: "roomMain", children: [
            /* @__PURE__ */ jsxDEV("div", { id: "senderPane", class: "pane hidden", children: [
              /* @__PURE__ */ jsxDEV("div", { id: "drop", class: "drop", children: [
                /* @__PURE__ */ jsxDEV("div", { class: "dropTitle", children: "DROP FILE HERE" }),
                /* @__PURE__ */ jsxDEV("div", { class: "muted small", children: "または" }),
                /* @__PURE__ */ jsxDEV("label", { class: "btn", children: [
                  "SELECT",
                  /* @__PURE__ */ jsxDEV("input", { id: "fileInput", type: "file", hidden: true })
                ] })
              ] }),
              /* @__PURE__ */ jsxDEV("div", { class: "row gap wrap", children: [
                /* @__PURE__ */ jsxDEV("button", { id: "sendBtn", class: "btn primary", disabled: true, children: "SEND" }),
                /* @__PURE__ */ jsxDEV("div", { class: "muted small", id: "fileInfo" })
              ] }),
              /* @__PURE__ */ jsxDEV("div", { class: "progress", children: [
                /* @__PURE__ */ jsxDEV("div", { class: "bar", children: /* @__PURE__ */ jsxDEV("div", { id: "sendBar", class: "fill", style: "width: 0%" }) }),
                /* @__PURE__ */ jsxDEV("div", { class: "muted small", id: "sendText", children: "0%" })
              ] })
            ] }),
            /* @__PURE__ */ jsxDEV("div", { id: "receiverPane", class: "pane hidden", children: [
              /* @__PURE__ */ jsxDEV("div", { class: "muted", children: "送信側がファイルを選ぶのを待っています..." }),
              /* @__PURE__ */ jsxDEV("div", { class: "progress", children: [
                /* @__PURE__ */ jsxDEV("div", { class: "bar", children: /* @__PURE__ */ jsxDEV("div", { id: "recvBar", class: "fill", style: "width: 0%" }) }),
                /* @__PURE__ */ jsxDEV("div", { class: "muted small", id: "recvText", children: "0%" })
              ] }),
              /* @__PURE__ */ jsxDEV("div", { id: "downloadArea", class: "hidden", children: [
                /* @__PURE__ */ jsxDEV("a", { id: "downloadLink", class: "btn primary", href: "#", children: "DOWNLOAD" }),
                /* @__PURE__ */ jsxDEV("div", { class: "muted small", id: "downloadMeta" })
              ] })
            ] })
          ] })
        ] })
